...
const Combos = () => {
  return (
    <main className='flex flex-col w-full pt-36 lg:flex-row'>
        <section data-aos="fade-right"  className='bg-combo1 w-full h-96 m-0 flex flex-col pt-32 '>
        ...
        <section data-aos="fade-left"  className='bg-combo2 w-full h-96 m-0 flex flex-col pt-32 '>
          <div className='max-w-xl mx-auto'>
