...
const Services = () => {
    ...
    return (
        <div>
            <section className='flex justify-center items-center flex-col pt-56 pb-32'>
            ...
            <section className='flex justify-around flex-wrap items-center max-w-screen-2xl mx-auto'>
